...
class MessageFormatV3(MessageFormatStrategy):

    def build_send_payload(self, message):
        msg_dict = self._build_standard_message_dict(self,message)
    ...
    def _add_mailjet_options(message, msg_dict):
        mailjet_attrs = {
    ...
    def _add_alternatives(message, msg_dict):
    ...
    def _add_attachments(message, msg_dict):
    ...
    def _make_attachment(attachment, str_encoding=None):
    ...
    def _parse_recipients(message, recipients):
        rcpts = []
